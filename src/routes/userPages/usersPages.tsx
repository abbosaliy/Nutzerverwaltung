      ...
      {user.map((userItem) => (
        ...
        >
          <div className="user__foto">
            <img
              className="user__foto-img"
              src={
                userItem.gender === 'mann'
          ...
          <div className="user__info">
            <div className="user__header">
              ...
              <button
                ...
                onClick={() =>
                  setUser({ type: 'REMOVE', payload: userItem.id })
                }
              >
                Delete
              </button>
            </div>
            <div className="user__daten">
              <div className="user__daten_box">
